...
import ru.rt.navigator.view.FormEventActivity;
...
public class NavigatorAdapterEvent extends RecyclerView.Adapter<NavigatorAdapterEvent.ViewHolder> {
    ...
    public NavigatorAdapterEvent(List<EventDto> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View rowView = layoutInflater.inflate(R.layout.list_row_event, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final String file = list.get(position).getFile();
        ...
        holder.programm.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void programIntent(String file) {
        String url = "http://navigator.rcvrrt.ru/files/" + file;
    ...
    public void add(int i, List<EventDto> eventDtos) {
        this.list.clear();
        this.list.addAll(i, eventDtos);
        notifyDataSetChanged();
        this.lastPosition = 0;
    }

    public void startFormActivity(String programTitle) {
        Intent intent = new Intent(context, FormEventActivity.class);
