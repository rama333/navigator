...
public class EventDto {
    ...
    public EventDto(String nameIntitution, Long idIntitution, String districtIntitution, String addressIntitution, String phone, Long id, String title, String startDate, String finishDate, String description, int minAge, int maxAge, String paidForm, String realizationForm, String file) {
